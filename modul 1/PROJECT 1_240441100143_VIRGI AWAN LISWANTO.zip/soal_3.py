#soal no3
# Jumlah nilai tukar 1 dolar = Rp 15.201
perkiraan_kurs_sesuai_tanggal_pratikum = 15.201
...
kurs = float(input(f"sedangkan kurs mata uang negara kita sekarang adalah:"))
